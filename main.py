    ...
    def show_add_person(self):
        ...
        while len(data[0].strip()) == 0 or len(data[0].strip()) > 32:
            if len(data[0].strip()) == 0:
                data[0] = input("Фамилия не может быть пустым! Введите Фамилию заново (-1 - отмена): ").strip()
                if data[0] == "-1":
                    return
            if len(data[0].strip()) > 32:
                data[0] = input("Фамилия не может быть длиннее 32 символов! Введите Фамилию заново (-1 - отмена): ").strip()
                if data[0] == "-1":
                    return
        ...
        while len(data[1].strip()) == 0 or len(data[1].strip()) > 32:
            if len(data[1].strip()) == 0:
                data[1] = input("Фамилия не может быть пустой! Введите имя заново (-1 - отмена): ").strip()
                if data[1] == "-1":
                    return
            if len(data[1].strip()) > 32:
                data[1] = input(
                    "Фамилия не может быть длиннее 32 символов! Введите имя заново (-1 - отмена): ").strip()
                if data[1] == "-1":
                    return
...
ID   Тип                 Серия          Номер          Дата"""
    ...
    def update_person(self):
        ...
        while len(data[0].strip()) == 0 or len(data[0].strip()) > 32:
            if len(data[0].strip()) == 0:
                data[0] = input(
                    "Фамилия не может быть пустым! Введите Фамилию заново (-1 - отмена, -2 - пропустить поле): ").strip()
                if data[0] == "-1":
                    return
                elif data[0] == "-2":
                    data[0] = str(PeopleTable().find_by_id(num)[1])
        ...
        while len(data[1].strip()) == 0 or len(data[1].strip()) > 32:
            if len(data[1].strip()) == 0:
                data[1] = input(
                    "Имя не может быть пустой! Введите Имя заново (-1 - отмена, -2 - пропустить поле): ").strip()
                if data[1] == "-1":
                    return
                elif data[1] == "-2":
                    data[1] = str(PeopleTable().find_by_id(num)[2])
